...
_main:
	...
	ar1 = 0x01
	C$main.c$57$1$0 ==.
;	../main.c:57: const uint8_t uart_msg[] = "\n\r** Simple LED Sequence  **\n\r";
;	genPointerSet
;     genFarPointerSet
...
;     genFarPointerSet
	...
	movx	@dptr,a
	C$main.c$58$1$0 ==.
;	../main.c:58: const uint8_t linefeed[] = "\n\r";
;	genPointerSet
;     genFarPointerSet
...
;     genFarPointerSet
	...
	movx	@dptr,a
	C$main.c$65$1$1 ==.
;	../main.c:65: UART_init( &g_stdio_uart, APB3_BASE_ADDRESS + COREUARTAPB_0, UART_9600_BAUD, DATA_8_BITS | NO_PARITY );
;	genAssign
...
;	genCall
	...
	lcall	_UART_init
	C$main.c$67$1$1 ==.
;	../main.c:67: WD_init( &g_wd, APB3_BASE_ADDRESS + COREWATCHDOG_0, WatchDog_COUNT, WD_PRESCALER_DIV_16 );
;	genAssign
...
;	genCall
	...
	lcall	_WD_disable
	C$main.c$70$1$1 ==.
;	../main.c:70: GPIO_init( &g_gpio,	APB3_BASE_ADDRESS + COREGPIO_0, GPIO_APB_32_BITS_BUS );
;	genAssign
...
;	genCall
	...
	lcall	_GPIO_init
	C$main.c$74$1$1 ==.
;	../main.c:74: GPIO_config( &g_gpio, LED_D0, GPIO_OUTPUT_MODE );
;	genAssign
...
;	genCall
	...
	lcall	_GPIO_config
	C$main.c$76$1$1 ==.
;	../main.c:76: GPIO_config( &g_gpio, LED_D1, GPIO_OUTPUT_MODE );
;	genAssign
	mov	dptr,#_GPIO_config_PARM_2
	mov	a,#0x01
	movx	@dptr,a
...
;	genCall
	...
	lcall	_GPIO_config
	C$main.c$79$1$1 ==.
;	../main.c:79: display_help();
;	genCall
	lcall	_display_help
	C$main.c$80$1$1 ==.
;	../main.c:80: display_prompt();
;	genCall
	lcall	_display_prompt
	C$main.c$87$1$1 ==.
;	../main.c:87: for ( sram_addr =0 ; sram_addr < 256 ; sram_addr++) {
;	genAssign
...
00122$:
	C$main.c$89$2$2 ==.
;	../main.c:89: HW_set_16bit_reg((APB3_BASE_ADDRESS + COREAPBSRAM_0)+ sram_addr, value );
;	genPlus
;	genPlusIncr
;     genPlus shortcut
	mov	ar4,r2
...
00109$:
	C$main.c$92$1$1 ==.
;	../main.c:92: for ( sram_addr =0 ; sram_addr < 256 ; sram_addr++) {
;	genAssign
	mov	dptr,#_main_sram_addr_1_1
	clr	a
	movx	@dptr,a
...
00123$:
	C$main.c$94$2$3 ==.
;	../main.c:94: testvar = HW_get_16bit_reg((APB3_BASE_ADDRESS + COREAPBSRAM_0)+ sram_addr);
;	genPlus
;	genPlusIncr
;     genPlus shortcut
	mov	ar4,r2
...
00104$:
	C$main.c$109$2$4 ==.
;	../main.c:109: rx_size = UART_get_rx(&g_stdio_uart, &rx_data[1],1);
;	genCast
...
;	genAssign
	...
	movx	@dptr,a
	C$main.c$114$3$5 ==.
;	../main.c:114: process_uart_data(key);
;	genCall
	mov	dpl,r2
...
;------------------------------------------------------------
	G$wait$0$0 ==.
	C$main.c$126$1$1 ==.
;	../main.c:126: void wait(int time_in_ms)
;	-----------------------------------------
;	 function wait
;	-----------------------------------------
_wait:
;	genReceive
	...
	movx	@dptr,a
	C$main.c$131$1$1 ==.
;	../main.c:131: for (i=0; i < time_in_ms*10000; i++)
;	genAssign
